                                ...
                                <div class="card-body">
                                    <form method="post">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-xl-6">
                                                <label class="form-control-label">Program<span
                                                        class="text-danger ml-2">*</span></label>
                                                <select class="form-control" name="Program" id="programSelect" required>
                                                    <option value="">Select Program</option>
                                                    <?php
                                                    if($editRow['Program'] ){
                                                    echo "<option value='{$editRow['Program']}' selected>{$editRow['Program']}</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            <div class="col-xl-6">
                                                ...
                                                <select class="form-control" name="Subject" id="subjectSelect" required>
                                                    ...
                                                    <?php
                                                    if ($editRow['Subject']){
                                                        echo "<option value='{$edit['Subject']}' selected>{$editRow['Subject']}</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-xl-6">
                                                <label class="form-control-label">Time<span
                                                        class="text-danger ml-2">*</span></label>
                                                <input type="text" class="form-control" name="Time"
                                                    placeholder="00:00-00:00" pattern="\d{2}:\d{2}-\d{2}:\d{2}"
                                                    title="Time must be in the format HH:MM-HH:MM"
                                                    value="<?php echo isset($editRow) ? $editRow['Time'] : ''; ?>"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <select class="form-control" name="Teacher" id="teacherSelect" required>
                                                    <option value="">Select Teacher</option>
                                                    <?php
                                                    if ($teachername){
                                                        $query = "SELECT * FROM Teachers WHERE TeacherName = '$teachername'";
                                                        $result = mysqli_query($conn, $query);
                                                        $row = mysqli_fetch_assoc($result);
                                                        echo "<option value='{$row['TeacherCode']}' selected>{$teachername}</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
            ...
            fetch('get_related_data.php', {
                ...
                .then(data => {
                    ...
                    data.teachers.forEach(teacher => {
                        teacherSelect.innerHTML += `<option value="${teacher.code}">${teacher.name}</option>`;
                    });
                })

...
<?php 
  $query = "SELECT Teachers.TeacherName From Teachers INNER JOIN HOD ON Teachers.TeacherID=HOD.TeacherID WHERE HOD.TeacherID = ".$_SESSION['userId']."";
  $rs = $conn->query($query);
  $num = $rs->num_rows;
  $rows = $rs->fetch_assoc();
...
<nav class="navbar navbar-expand navbar-light bg-gradient-primary topbar mb-4 static-top">
        ...
        <div class="text-white big ml-2" style="margin-left:100px;"><b>Alhamd Academic System</b></div>

                                ...
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <div class="col-xl-6">
                                                ...
                                                <?php
                                                $query = "SELECT ProgramName FROM Programs WHERE Department = '$_SESSION[deptName]'";
                                                print_r($query);
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <?php
                                            $query = "SELECT * FROM Departments WHERE DeptName = '$_SESSION[deptName]'";
                                            $result = mysqli_query($conn, $query);
                                            while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="table-responsive p-3">
                                            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $query = "SELECT * FROM Students WHERE Department = '$_SESSION[deptName]'";
                                                    $rs = $conn->query($query);
                                                    $sn = 0;
                                                    if ($rs->num_rows > 0) {
